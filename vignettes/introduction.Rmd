...
f1 <- facet_plot(gg, panel="hierBAPS", data=plot.df, geom=geom_tile, aes(x=val), color='red')
f2 <- facet_plot(f1, panel="fastbaps level 1", data=plot.df, geom=geom_tile, aes(x=fastbaps), color='blue')
f2 <- facet_plot(f1, panel="fastbaps level 2", data=plot.df, geom=geom_tile, aes(x=fastbaps2), color='green')
f2
```
